...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // Functions
    ...
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_NLCK,   _______,  _______,  _______, KC_BSPC, KC_DEL,
    ...
    DM_RSTP,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______, _______,  MARKUP_CODE,  _______, DELBSPC,  KC_DEL,
